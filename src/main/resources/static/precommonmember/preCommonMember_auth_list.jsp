...
function deatilUI(id){
	var  action =  "/admin/preCommonMember/auth_detail/"+id;
...
//修改后保存
function update(){
	var jsonData = $("#auth_updateForm").serialize();
    var params = decodeURIComponent(jsonData,true);//处理时间10:00,提交的时候乱码 103A00
	var action ="${pageContext.request.contextPath}/admin/preCommonMember/authUpdate";
	$.post(action, params, function(data){
		  if(data.meta.code=="88"){
       		  alert(data.meta.message);
	       	  window.location.href="${pageContext.request.contextPath}/admin/preCommonMember/authList";
...
<body style="font-size: 12px; font-family: 微软雅黑">
	...
	<div class="container" style="width: 80%;">
		<div style="float: left;">
			<form method="post" action="authList" id="form-select" class="form-inline">
